...
#   DIRECOTRIES INFOS   #
#########################
export SFMAGIC_ROOT=$(realpath $(dirname "${BASH_SOURCE[0]}"))
# export PACKAGES="${SFMAGIC_ROOT}/packages"
...
# export WORKFLOW_DIR="${SFMAGIC_ROOT}/workflow"
...
# # SPECFEM
# export SPECFEM_DIR="${SFMAGIC_ROOT}/specfem3d_globe"
